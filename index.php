  ...
  <div class="container">
    <div class="row align-items-center">
      <div class="col-lg-7">
        ...
        <h1 class="mt-3">Shaping Nepal's Next Generation of <span style="color:#a6f0c6">Nursing Leaders</span></h1>
        <p class="lead mt-3">BPKMCH Nursing College, Cancer Gate Bharatpur — delivering quality nursing education,
          clinical excellence and compassionate care since inception.</p>
        ...
        <div class="col-md-6 col-lg-3">
          <div class="program-card">
            <div class="card-top">
              ...
              <h5 class="mt-2 mb-0"><?php echo htmlspecialchars($p['name']); ?></h5>
            </div>
            <div class="card-body">
              ...
              <p class="text-muted small mb-0"><?php echo htmlspecialchars(substr($p['description'], 0, 100)); ?>...</p>
            </div>
          </div>
        </div>
      <?php endwhile; ?>
    ...
    <?php while ($n = $notices->fetch_assoc()): ?>
      <div class="notice-item">
        ...
        <div class="notice-date mb-1"><i
            class="bi bi-calendar3 me-1"></i><?php echo date('M d, Y', strtotime($n['posted_on'])); ?></div>
        <p class="mb-0 text-muted small"><?php echo htmlspecialchars($n['body']); ?></p>
      </div>
    <?php endwhile; ?>
  </div>
</section>
